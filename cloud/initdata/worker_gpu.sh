...
echo 'aws s3 cp s3://{}/heroku.env /home/ubuntu/heroku.env && . /home/ubuntu/heroku.env && cd /home/ubuntu/DeepVideoAnalytics/cloud/compose && nvidia-docker-compose -f {} up -d > launch.log 2>error.log &' >> /home/ubuntu/startup.sh
