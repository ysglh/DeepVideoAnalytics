...
urlpatterns = [
    ...
    url(r'^detections/(?P<pk>\d+)/$', views.DetectionDetail.as_view(), name='detections_detail'),
    ...
    url(r'^yolo_train', views.yolo_train, name='yolo_train'),
    url(r'^yolo_detect', views.yolo_detect, name='yolo_detect'),
