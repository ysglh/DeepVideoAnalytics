...
g++ -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 -undefined dynamic_lookup -shared high_dim_filter.cc modified_permutohedral.cc -fPIC -I $TF_INC -O2 -o high_dim_filter.so
